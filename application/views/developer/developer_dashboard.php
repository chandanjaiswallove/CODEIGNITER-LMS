...
<body>
                                    ...
                                    <ul class="rts-dropdown-menu switcher-language">
                                        <li class="has-child-menu">
                                            <a href="assignments.html#">
                                                <img class="left-image" src="<?php echo base_url(); ?>modules/webmaster/assets/images/flag-01.svg" alt="Language Images">
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="assignments.html#">
                                                        <img class="left-image" src="<?php echo base_url(); ?>modules/webmaster/assets/images/flag-03.svg" alt="Language Images">
                                                        <span class="menu-item">Deutsch</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="assignments.html#">
                                                        <img class="left-image" src="<?php echo base_url(); ?>modules/webmaster/assets/images/flag-02.svg" alt="Language Images">
                                                        <span class="menu-item">Portuguese</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="assignments.html#">
                                                        <img class="left-image" src="<?php echo base_url(); ?>modules/webmaster/assets/images/flag-04.svg" alt="Language Images">
                    ...
                    <div class="header-one-wrapper">
                        <div class="left-side-header">
                            <a href="index.html" class="logo-area">
                                <img src="<?php echo base_url(); ?>modules/webmaster/assets/images/logo/logo-1.svg" alt="logo">
                            </a>
                                ...
                                <nav>
                                    <ul>
                                        <li class="has-dropdown" style="position: static;">
                                            <a class="nav-link" href="assignments.html#">Home</a>
                                            ...
                                            <ul class="megamenu-hub">
                                                <li>
                                                    ...
                                                    <div class="absolute-image-shape shape-image">
                                                        <img class=" shape one" src="<?php echo base_url(); ?>modules/webmaster/assets/images/nav/02.png" data-speed="0.04" data-revert="true" alt="nav">
                                                        <img class=" shape two" src="<?php echo base_url(); ?>modules/webmaster/assets/images/nav/03.png" data-speed="0.04" alt="nav">
                                                    </div>
                                                    <div class="nav-mega-image">
                                                        <a href="single-course.html">
                                                            <img src="<?php echo base_url(); ?>modules/webmaster/assets/images/nav/01.jpg" alt="nav">
                                                        </a>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="has-dropdown">
                                            <a class="nav-link" href="assignments.html#">Pages</a>
                                            <ul class="submenu">
                                        ...
                                        <li class="has-dropdown" style="position: static;">
                                            <a class="nav-link" href="assignments.html#">Courses</a>
                                            <ul class="megamenu-hub min-mega shape-move">
                                                <li>
                                                    <ul class="">
                                                        <li class="parent"><a href="assignments.html#">Courses</a></li>
                                                    ...
                                                    <ul class="">
                                                        <li class="parent"><a href="assignments.html#">Courses Details</a></li>
                                                    ...
                                                    <ul class="">
                                                        <li class="parent"><a href="assignments.html#">Others</a></li>
                                                    ...
                                                    <div class="thumbnav-area">
                                                        ...
                                                        <a href="create-course.html" class="single-thumbnav">
                                                            <div class="icon">
                                                                <img src="<?php echo base_url(); ?>modules/webmaster/assets/images/nav/04.png" alt="nav">
                                                            </div>
                                                        ...
                                                        <a href="lesson-details.html" class="single-thumbnav mash">
                                                            <div class="icon">
                                                                <img src="<?php echo base_url(); ?>modules/webmaster/assets/images/nav/05.png" alt="nav">
                                                            </div>
                                                        ...
                                                        <a href="instructor.html" class="single-thumbnav">
                                                            <div class="icon">
                                                                <img src="<?php echo base_url(); ?>modules/webmaster/assets/images/nav/06.png" alt="nav">
                                                            </div>
                                        ...
                                        <li class="has-dropdown">
                                            <a class="nav-link" href="assignments.html#">Dashboard</a>
                                            <ul class="submenu">
                                                <li class="sub-dropdown">
                                                    ...
                                                    <ul class="submenu third-lvl base">
                                                        ...
                                                        <li><a class="mobile-menu-link" href="">Enroll Admin</a></li>
                                        ...
                                        <li class="has-dropdown">
                                            <a class="nav-link" href="assignments.html#">Blog</a>
                                            <ul class="submenu">
                    ...
                    <div class="dashboard-banner-area-start bg_image">
                        ...
                        <div class="author-profile-image-and-name">
                            <div class="profile-pic">
                                <img src="<?php echo base_url(); ?>modules/webmaster/assets/images/dashboard/01.png" alt="dashboard">
                            </div>
                            <div class="name-desig">
                                ...
                                <div class="course-vedio">
                                    <div class="single">
                                        ...
                                        <span>0 Institutes Onboarded</span>
                                    </div>
                                    <div class="single">
                ...
                <div class="col-lg-3 rts-sticky-column-item">
                    <div class="left-sindebar-dashboard  theiaStickySidebar">
                        <div class="dashboard-left-single-wrapper">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="<?php echo base_url('enroll_newAdmin'); ?>" class="single-item ">
                        ...
                        <div class="dashboard-left-single-wrapper mt--40">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="assignments.html" class="single-item active">
                        ...
                        <div class="dashboard-left-single-wrapper bbnone mt--40">
                            ...
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="<?php echo base_url('developerLogout'); ?>" class="single-item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-dashboard-inner">
                        <p>Copyright © 2024 All Rights Reserved by <a href="assignments.html#">Studyhub</a></p>
                        <a href="index.html">
                            <img src="<?php echo base_url(); ?>modules/webmaster/assets/images/logo/logo-4.svg" alt="logo">
                        </a>
                        <div class="social-area-dashboard-footer">
                            <ul>
                                <li><a href="assignments.html#"><i class="fa-brands fa-facebook-f"></i></a></li>
                                <li><a href="assignments.html#"><i class="fa-brands fa-instagram"></i></a></li>
                                <li><a href="assignments.html#"><i class="fa-brands fa-linkedin"></i></a></li>
                                <li><a href="assignments.html#"><i class="fa-brands fa-pinterest"></i></a></li>
                                <li><a href="assignments.html#"><i class="fa-brands fa-youtube"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="assignments.html#" class="modal-form">
                        <select class="nice-select" name="price">
        ...
        <div class="product-area">
            <div class="product-item">
                <div class="product-detail">
                    <div class="product-thumb"><img src="<?php echo base_url(); ?>modules/webmaster/assets/images/course/cart/01.jpg" alt="product-thumb"></div>
                ...
                <div class="cart-edit">
                    ...
                    <div class="item-wrapper d-flex mr--5 align-items-center">
                        <a href="assignments.html#" class="product-edit"><i class="fal fa-edit"></i></a>
                        <a href="assignments.html#" class="delete-cart"><i class="fal fa-times"></i></a>
                    </div>
                </div>
            </div>
            <div class="product-item">
                <div class="product-detail">
                    <div class="product-thumb"><img src="<?php echo base_url(); ?>modules/webmaster/assets/images/course/cart/02.jpg" alt="product-thumb"></div>
                    <div class="item-wrapper">
            ...
            <div class="product-item last-child">
                <div class="product-detail">
                    <div class="product-thumb"><img src="<?php echo base_url(); ?>modules/webmaster/assets/images/course/cart/03.jpg" alt="product-thumb"></div>
                    <div class="item-wrapper">
    ...
    <div id="side-bar" class="side-bar header-two">
        ...
        <div class="mobile-menu-main">
            <nav class="nav-main mainmenu-nav mt--30">
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    <li class="has-droupdown">
                        <a href="assignments.html#" class="main">Home</a>
                    ...
                    <li class="has-droupdown">
                        <a href="assignments.html#" class="main">Pages</a>
                        <ul class="submenu mm-collapse">
                            ...
                            <li class="has-droupdown third-lvl">
                                <a class="main" href="assignments.html#">Zoom</a>
                            ...
                            <li class="has-droupdown third-lvl">
                                <a class="main" href="assignments.html#">Event</a>
                                <ul class="submenu-third-lvl mm-collapse">
                            ...
                            <li class="has-droupdown third-lvl">
                                <a class="main" href="assignments.html#">Shop</a>
                                <ul class="submenu-third-lvl mm-collapse">
                    ...
                    <li class="has-droupdown">
                        <a href="assignments.html#" class="main">Course</a>
                        <ul class="submenu mm-collapse">
                            <li><a href="assignments.html#" class="tag">Courses</a></li>
                            <li><a class="mobile-menu-link" href="course-one.html">Courses</a></li>
                            <li><a class="mobile-menu-link" href="course-two.html">Course List</a></li>
                            <li><a class="mobile-menu-link" href="course-three.html">Course Grid</a></li>
                            <li><a class="mobile-menu-link" href="course-four.html">Course List Two</a></li>
                        ...
                        <ul class="submenu mm-collapse">
                            <li><a href="assignments.html#" class="tag">Courses Details</a></li>
                        ...
                        <ul class="submenu mm-collapse">
                            <li><a href="assignments.html#" class="tag">Others</a></li>
                    ...
                    <li class="has-droupdown">
                        <a href="assignments.html#" class="main">Dashboard</a>
                        <ul class="submenu mm-collapse">
                            <li class="has-droupdown third-lvl">
                                <a class="main" href="assignments.html#">Instructor Dashboard</a>
                                <ul class="submenu-third-lvl mm-collapse">
                            ...
                            <li class="has-droupdown third-lvl">
                                <a class="main" href="assignments.html#">Students Dashboard</a>
                                <ul class="submenu-third-lvl mm-collapse">
                    ...
                    <li class="has-droupdown">
                        <a href="assignments.html#" class="main">Blog</a>
                        <ul class="submenu mm-collapse">
            ...
            <div class="buttons-area">
                <a href="assignments.html#" class="rts-btn btn-border">Log In</a>
                <a href="assignments.html#" class="rts-btn btn-primary">Sign Up</a>
            </div>
