...
<?php if (!empty($showGapSection) && $showGapSection): ?>
    <?php $this->load->view('sections/gapsection'); ?>
<?php endif; ?>
...
<div class="footer-callto-action-area bg-light-1">
    ...
    <?php if (!empty($showSingleHeading) && $showSingleHeading): ?>
        <?php $this->load->view('sections/singleheading'); ?>
    <?php endif; ?>
            ...
            <div class="col-lg-12">
                ...
                <div class="footer-one-main-wrapper">
                    ...
                    <div class="footer-singl-wized left-logo">
                        <div class="head">
                            <a href="#">
                                <img src="<?php echo base_url('assets/images/logo/logo-1.svg'); ?>" alt="logo" loading="lazy">
                            </a>
                        </div>
                        <div class="body">
                            <p class="dsic">
